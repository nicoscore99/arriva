...
from displays import ConnectionsFrame, SignalFrame, ErrorFrame, WeatherFrame
...
def main():
    ...
    static_image = WeatherFrame()

    forecasts = test_dict['forecast']['day']

    image = static_image.get(forecasts)
